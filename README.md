moria采用开源框架gin-vue-admin开发

## 1. 基本介绍

### 1.1 项目介绍

> GVA是一个基于 [vue](https://vuejs.org) 和 [gin](https://gin-gonic.com) 开发的全栈前后端分离的开发基础平台，集成jwt鉴权，动态路由，动态菜单，casbin鉴权，表单生成器，代码生成器等功能，提供多种示例文件，让您把更多时间专注在业务开发上。


### 1.2 开发规范
1.目前开发人员有限，项目分支分为master(主分支),dev(开发环境分支),feature(日常开发分支),bugifx(BUG修正)
...
指定配置文件启动方式 【./server -c ../deployment/server/config.local.yaml】
